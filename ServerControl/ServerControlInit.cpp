/*
 * ServerControlInit.cpp
 *
 *  Created on: 20-Nov-2023
 *      Author: kumar
 */

#include "ServerControlInit.h"
#include <iostream>
...
int main(int argc, char* argv[]){
	ServerControlInit s;// = new ServerControlInit();
	s.initServer();
};

ServerControlInit::ServerControlInit() {
...
int ServerControlInit::initServer(){
